...
const projects = [
  {
    srcPath: "src/assets/projects/members-only.png",
  ...
  {
    srcPath: "src/assets/projects/battleship.png",
  ...
  {
    srcPath: "src/assets/projects/TNW.jpg",
  ...
  {
    srcPath: "src/assets/projects/weather-app.png",
  ...
  {
    srcPath: "src/assets/projects/KBstore.png",
  ...
  {
    srcPath: "src/assets/projects/portfolio.png",
